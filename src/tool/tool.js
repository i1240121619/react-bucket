...
export function cues(obj) {
  ...
  newDiv.innerHTML =
    '<div class="cues-box cues_animation_in"><div class="cues-box-icon"><i class="cues-toast-icon ' +
    obj.type +
    '-icon"></i></div><div class="cues-box-content">' +
    obj.txt +
    "</div></div>";
  setTimeout(function() {
    let cuesbox = document.querySelector(".cues-box");
...
export function dialog(obj, callback1, callback2) {
  ...
  document.body.appendChild(newDiv);
  newDiv.innerHTML =
    '<div class="js_dialog yp-popIn"><div class="yp-mask"></div><div class="yp-dialog"><div class="yp-dialog__hd"><strong class="yp-dialog__title">' +
    obj.title +
    '</strong></div><div class="yp-dialog__bd">' +
    obj.content +
    '</div><div class="yp-dialog__ft"><a href="javascript:;" class="yp-dialog__btn yp-dialog__btn_default">取消</a><a href="javascript:;" class="yp-dialog__btn yp-dialog__btn_primary">确定</a></div></div></div>';
  let a1 = document.querySelector(".yp-dialog__btn_default");
  let a2 = document.querySelector(".yp-dialog__btn_primary");
  a1.addEventListener(
    "click",
    function() {
      callback1();
...
export function getQueryString(key) {
  ...
  let r = string.split("?")[1].match(reg);
...
export function Ajax(url, method, bodyObj) {
  return reqwest({
    url, // URL
    method, // 请求方式
